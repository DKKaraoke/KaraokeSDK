...
extension KeyedDecodingContainer {
    func decodeIfAccaptable<T: Decodable>(_ type: T.Type, forKey key: KeyedDecodingContainer<K>.Key) throws -> T where T: LosslessStringConvertible {
        ...
        throw DecodingError.typeMismatch(T.self, .init(codingPath: codingPath, debugDescription: "Expected to decode `\(T.self)/String` but found a `Unknown` instead.", underlyingError: nil))
    }
