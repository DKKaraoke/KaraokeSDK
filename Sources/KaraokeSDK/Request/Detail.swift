...
public final class Detail: RequestType {
    ...
    public var baseURL: URL = .init(string: "https://csgw.clubdam.com/dkwebsys/search-api/")!
    ...
    public struct DataClass: Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            artistCode = try container.decode(Int.self, forKey: .artistCode)
            artist = try container.decode(String.self, forKey: .artist)
            requestNo = try container.decode(String.self, forKey: .requestNo)
            title = try container.decode(String.self, forKey: .title)
            titleYomiKana = try container.decode(String.self, forKey: .titleYomiKana)
